...
{"shots":[{"index":1,"description":"画面描述:运镜+出场人物(用'参考图N人物'指代,N 按 characters 数组顺序从1编号)+动作+表情+人物朝向,150字内","characters":["按出场顺序的角色名"],"dialogue":["角色名：台词"]}]}
要求:
...
4.description 中的'参考图N'编号必须与 characters 数组顺序一致;dialogue 每行说话人必须是 characters 数组中的人物,每镜 dialogue 最多2句且说话人不同,可空数组;
5.转场衔接:第2镜起每镜 description 必须以一句"承接上镜"开头,说明从上一镜末画面如何过渡(动作自然延续/镜头摇向/视线转移/同场景走位衔接等),确保相邻两镜画面不跳变;全片人物服装发型、场景光线保持连续统一。`,
};
