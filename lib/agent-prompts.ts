...
{"shots":[{"index":1,"scene":"本镜发生的场景名,必须是可用场景之一","description":"画面描述:运镜+出场人物(用'<Picture N>人物'指代,N 按 characters 数组顺序从1编号)+动作+表情+人物朝向,150字内","characters":["按出场顺序的角色名"],"dialogue":["角色名：台词"]}]}
要求:
