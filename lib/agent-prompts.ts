...
4.description 中的'<Picture N>'编号必须与 characters 数组顺序一致;dialogue 每行说话人必须是 characters 数组中的人物,每镜 dialogue 最多2句且说话人不同,可空数组;道具出镜时 description 必须写出道具名称(与可用道具资产名一致);
