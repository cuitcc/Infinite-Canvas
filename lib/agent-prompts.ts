...
{"shots":[{"index":1,"scene":"本镜发生的场景名,必须是可用场景之一","description":"画面描述:运镜+出场人物(用'<Picture N>人物'指代,N 按 characters 数组顺序从1编号)+动作+表情+人物朝向,300字内,写满写细:动作分解、表情变化、光影氛围、机位变化都展开","characters":["按出场顺序的角色名"],"dialogue":["角色名：台词"]}]}
要求:
...
4.description 中的'<Picture N>'编号必须与 characters 数组顺序一致;dialogue 每行说话人必须是 characters 数组中的人物,每镜 dialogue 最多2句且说话人不同,可空数组;台词量必须与每镜时长匹配(输入的 secondsPerShot,秒):按每句台词约4秒估算,6秒及以下的镜头最多1句,台词务必短促;道具出镜时 description 必须写出道具名称(与可用道具资产名一致);
